...
- [x] Make the idempotent Almanac seed an explicit manual-workflow option that defaults to off.
...
- [x] Run the remote migration and deployment, then verify `/api/health/db` manually.
