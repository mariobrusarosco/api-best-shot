...
5. `PATCH /api/v2/admin/tournaments/:tournamentId/teams`
   - V2 teams update
6. `POST /api/v2/admin/tournaments/:tournamentId/rounds`
   - V2 rounds create
7. `PATCH /api/v2/admin/tournaments/:tournamentId/rounds`
   - V2 rounds update
8. `POST /api/v2/admin/tournaments/:tournamentId/matches`
   - V2 matches create
9. `PATCH /api/v2/admin/tournaments/:tournamentId/matches`
   - V2 matches update
10. `tournaments.current_round_sync`
...
1. round-specific matches update / single-match sync
