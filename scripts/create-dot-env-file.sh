...
create_dot_env_file() {
  ...
  echo "AWS_ACCESS_KEY_ID=0000000000000000" >> $PATH_TO_ENV_FILE
  echo "AWS_SECRET_ACCESS_KEY=0000000000000000" >> $PATH_TO_ENV_FILE
  echo "AWS_BUCKET_NAME=bestshot-dev" >> $PATH_TO_ENV_FILE
  echo "JWT_SECRET=0000000000000000" >> $PATH_TO_ENV_FILE
  echo "MEMBER_PUBLIC_ID_COOKIE=0000000000000000" >> $PATH_TO_ENV_FILE
